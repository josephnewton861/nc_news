        ...
        describe('INVALID PATHS', () => {
            ...
            describe('/articles', () => {
                describe('GET', () => {
                    ...
                    it('status: 404 topic query does not exist on db', () => {
                        return request(app).get('/api/articles?topic=not-a-topic')
                            .expect(404)
                            .then(({ body: { msg } }) => {
                                expect(msg).to.equal('topic not-a-topic does not exist on db')
                            })
                    })
                    it('status: 404 author query does not exist on db', () => {
                        return request(app).get('/api/articles?author=not-an-author')
                            .expect(404)
                            .then(({ body: { msg } }) => {
                                expect(msg).to.equal('author not-a-author does not exist on db')
                            })
                    })
                ...
                describe('/:article_id', () => {
                    ...
                    describe('/comments', () => {
                        describe('POST', () => {
                            ...
                            it('status: 404 article_id does not exist in db', () => {
